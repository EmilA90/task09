...
export const Search = () => {
    ...
    useEffect(() => {
        const results = pizzaList.filter(pizza =>
          pizza.toLowerCase().includes(inputText)  
        )
    ...
    return (
        ...
        <div className="search-input input-group mb-3">
            ...
            <button onClick={handleInput} className="btn btn-outline-secondary" type="button" id="button-addon2">Search</button>
        </div>
    )
}
